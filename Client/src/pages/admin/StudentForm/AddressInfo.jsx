      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="sm:col-span-3">
          ...
          <input
            ...
            className={`mt-1 block w-full rounded-md border ${errors.villageName ? "border-red-500" : "border-gray-300"
        ...
        <div className="sm:col-span-3">
          ...
          <select
            ...
            className={`mt-1 block w-full rounded-md border ${errors.province ? "border-red-500" : "border-gray-300"
              } py-2 px-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
          >
        ...
        <div className="sm:col-span-3">
          ...
          <select
            ...
            className={`mt-1 block w-full rounded-md border ${errors.district ? "border-red-500" : "border-gray-300"
              } py-2 px-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
        ...
        <div className="sm:col-span-3">
          ...
          <select
            ...
            className={`mt-1 block w-full rounded-md border ${errors.municipality ? "border-red-500" : "border-gray-300"
              } py-2 px-3 text-gray-900 shadow-sm focus:ring-2 focus:ring-indigo-600 sm:text-sm`}
