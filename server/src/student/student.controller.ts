...
export class StudentController {
  ...
  // }
  @Post('create')
  async createStudent(@Body() createStudentDto: StudentDto, registerUserDto:RegisterUserDto) {
    return this.studentService.createStudent(createStudentDto, registerUserDto);
  }
