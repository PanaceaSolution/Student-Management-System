...
export class NoticeService {
  ...
  async create(createNoticeDto: CreateNoticeDto, file?: Express.Multer.File):Promise<Notice>{
  ...
  async update(noticeID : string, updateNoticeDto:UpdateNoticeDto,file?:Express.Multer.File): Promise<Notice> {
